<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="flex flex-col lg:flex-row lg:justify-between"> 
                <div class="flex items-center">
                    <div class="flex items-center gap-1">
                        ...
                        <a class="btn btn-success" href="/back/valid_id/{{$data['id']}}/id?v={{$data['updated_at']}}" target="_blank">View ID</a>
                        @endif

                        <a class="btn btn-success" href="/org/info/{{$data['id']}}/edit">Edit Info</a>
                        <a class="btn btn-success" href="/org/info/{{$data['id']}}/edit">Edit Account</a>
                    </div>

                    <details class="dropdown">
                        <summary class="m-1 btn btn-success">Others</summary>
                        <ul class="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-52">
                            <li><a href="/org/profile/password/{{$data['id']}}/edit">Change Password</a></li>
                        </ul>
                    </details>
        ...
        <div class="app-plate">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 mb-3">
                ...
                <div class="flex items-center mb-3">
                    ...
                    <div class="pl-2">
                        <p class="">{{$data['region']}}, {{$data['municipal']}}</p>
    ...
    <div class="grid grid-cols-1 gap-4 min-w-0 {{$data['is_pending'] ? '' : 'h-fit'}}">
        <div class="app-plate">
            <div class="h-full w-full">
                <a href="{{$data['profile']}}" data-lightbox="image-profile" data-title="{{$data['name']}}">
                    <img class="object-cover  w-full h-full rounded-lg" src="{{$data['profile']}}" alt="">
                </a>
            </div>
        </div>
        <div class="app-plate">
            ...
            <div class="flex justify-end">
                <a href="/org/activity/{{$data['id']}}" class="uppercase text-sm font-semibold inline-flex items-center rounded-lg text-blue-600 hover:text-blue-700 dark:hover:text-blue-500  hover:bg-gray-100 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 px-3 py-2">
                    More Logs
